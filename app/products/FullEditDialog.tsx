...
import { ButtonIcon, List, ListItem, CardBody, CardHeader, CardFooter, Button, CloseButton } from '@reusable-ui/components';
    ...
    return (
        <>
            ...
            <Tab
                ...
                defaultValue='info'
            >
                <TabOption value='info' label={PAGE_PRODUCTS_TAB_INFORMATIONS}>
                    <p>hello</p>
                </TabOption>
