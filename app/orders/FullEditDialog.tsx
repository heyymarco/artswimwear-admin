...
export const FullEditDialog = (props: FullEditDialogProps) => {
    ...
    const [visibility      , setVisibility      ] = useState<OrderVisibility>(order.visibility as OrderVisibility);
    const [name            , setName            ] = useState<string>(order.name);
    const [path            , setPath            ] = useState<string>(order.path);
    const [price           , setPrice           ] = useState<number>(order.price);
    const [shippingWeight  , setShippingWeight  ] = useState<number|null>(order.shippingWeight ?? null);
    const [stock           , setStock           ] = useState<number|null>(order.stock          ?? null);
            ...
            >
                ...
                <TabPanel label={PAGE_PRODUCTS_TAB_DESCRIPTION}>
                    ...
                    >
                        ...
                        <EditorPlugin
                            // accessibilities:
                            placeholder='Type order description here...'
                        />
                    </WysiwygEditor>
                </TabPanel>
            </Tab>
