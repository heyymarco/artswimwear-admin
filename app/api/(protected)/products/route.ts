...
const createProductVariantGroupDiff = (productVariantGroups: ProductVariantGroupDetail[], productVariantGroupOris : ProductVariantGroupDetail[]): ProductVariantGroupDiff => {
